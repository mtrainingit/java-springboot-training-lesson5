...
public class AutenticacionController {
    ...
    private final UsuarioAUsuarioResponseDTOMapper usuarioToUsuarioDTOMapper;
    private final JWTUtility jwtUtility;

    public AutenticacionController(
            AutenticacionService autenticacionService,
            UsuarioAUsuarioResponseDTOMapper usuarioToUsuarioDTOMapper, JWTUtility jwtUtility
    ) {
        this.autenticacionService = autenticacionService;
        this.usuarioToUsuarioDTOMapper = usuarioToUsuarioDTOMapper;
    ...
    public ResponseEntity<?> login(@RequestBody LoginDTO loginDTO) {
        ...
        return ResponseEntity.ok()
                .header(HttpHeaders.AUTHORIZATION, jwtUtility.expedirToken(
                        usuario.getId().toString(),
                        usuario.getEmail(),
                        Map.of("scopes", usuario.getAuthorities())
                ))
                .body(usuarioToUsuarioDTOMapper.apply(usuario));
    }
}
